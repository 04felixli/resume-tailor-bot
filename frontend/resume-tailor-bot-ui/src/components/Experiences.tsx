...
function ExperienceCard({
  ...
  return (
    <div className="rounded-2xl border border-slate-800 bg-slate-900/80 shadow-sm p-4 mb-4 relative flex flex-col">
      <button
        onClick={onDelete}
      ...
      <div className="mb-2 flex gap-3">
        <div className="flex flex-col w-[34%]">
          <label className="text-xs text-slate-400 mb-1">Company Name</label>
          <input
            type="text"
        ...
        <div className="flex flex-col w-[34%]">
          <label className="text-xs text-slate-400 mb-1">Role/Title</label>
          <input
            type="text"
      ...
      <textarea
        ...
        className="w-full min-h-[100px] rounded-lg border border-slate-700 bg-slate-950 px-3 py-2 text-sm"
      />
    </div>
  );
}
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-semibold text-slate-200">Experiences</h2>
        <button
      ...
      {experiences.length === 0 && (
        <div className="text-slate-400 mb-4">No experiences added yet.</div>
      )}
      {experiences.map((exp) => (
        <ExperienceCard
          key={exp.id}
