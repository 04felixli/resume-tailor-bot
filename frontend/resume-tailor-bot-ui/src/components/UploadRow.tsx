...
export default function UploadRow() {
  ...
  return (
    <div className="flex items-center gap-3">
      <button
        onClick={onPickFile}
        className="inline-flex items-center gap-2 rounded-xl border border-slate-700 bg-slate-950 px-4 py-2 text-sm font-medium shadow-sm hover:shadow transition"
      >
      ...
      />
      {resumeFile ? (
        <div className="text-sm text-slate-300 truncate max-w-[60ch] flex items-center gap-2">
